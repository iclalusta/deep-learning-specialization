...
def single_test(test_cases, target):
    ...
    if success == len(test_cases):
        print("\033[92m All tests passes.")
    else:
        print('\033[92m', success, "tests passed")
        print('\033[91m', len(test_cases) - success, "tests failed")
        raise AssertionError("not all tests were passed for {}. check your bla bla.".format(target.__name__))
...
def multiple_test(test_cases, target):
    ...
    if success == len(test_cases):
        ...
        print("\033[92m", success, "tests passed.")
        print("\033[92m", len(test_cases)-success, "tests failed.")
        raise AssertionError("not all tests were passed for {}. check bla bla.".format(target.__name__))
